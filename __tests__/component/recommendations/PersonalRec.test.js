...
import PersonalRec from '../../../src/components/recommendations/PersonalRec';
...
describe('PersonalRec Component', () => {
  ...
  it('renders correctly with movies', () => {
    ...
    expect(screen.getByText('Personal Recommendations')).toBeTruthy();
