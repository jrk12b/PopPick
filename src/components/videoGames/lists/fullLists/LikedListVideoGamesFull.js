 ...
 */
function LikedListVideoGamesFull({likedListVideoGames, handleShowOptions}) {
  return (
    <FlatList
      ...
      ListHeaderComponent={
        <Text style={styles.sectionTitle}>
          Liked List ({likedListVideoGames.length})
        </Text>
      }
      ListEmptyComponent={
...
export default LikedListVideoGamesFull;
