 ...
 */
function PersonalRecVideoGamesFull({personalVideoGames, handleShowOptions}) {
  return (
    <FlatList
      ...
      renderItem={({item}) => (
        <VideoGamePoster
          ...
          listType="PersonalRecVideoGames"
        />
      )}
      numColumns={3}
      ...
      ListHeaderComponent={
        <Text style={styles.sectionTitle}>
          Personal Rec List ({personalVideoGames.length})
        </Text>
      }
      ListEmptyComponent={
...
export default PersonalRecVideoGamesFull;
